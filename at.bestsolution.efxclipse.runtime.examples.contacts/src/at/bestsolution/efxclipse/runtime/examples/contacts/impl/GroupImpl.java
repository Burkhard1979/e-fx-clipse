 ...
 * <ul>
 *   <li>{@link at.bestsolution.efxclipse.runtime.examples.contacts.impl.GroupImpl#getName <em>Name</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.runtime.examples.contacts.impl.GroupImpl#getContacts <em>Contacts</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.runtime.examples.contacts.impl.GroupImpl#getGroups <em>Groups</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class GroupImpl extends EObjectImpl implements Group {
	...
	protected EClass eStaticClass() {
		return ContactsPackage.Literals.GROUP;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ContactsPackage.GROUP__NAME, oldName, name));
	}
	...
	public EList<Contact> getContacts() {
		if (contacts == null) {
			contacts = new EObjectContainmentEList<Contact>(Contact.class, this, ContactsPackage.GROUP__CONTACTS);
		}
		return contacts;
	}
	...
	public EList<Group> getGroups() {
		if (groups == null) {
			groups = new EObjectContainmentEList<Group>(Group.class, this, ContactsPackage.GROUP__GROUPS);
		}
		return groups;
	}
