...
//		new CubicConnectionAdapter(connection, pane);
		...
		endPoint.setX(300);
		endPoint.setY(300);
		straightLine.getPoints().add(endPoint);
...
//		new LinePointAdapter(endPoint, pane);
	...
	// at.bestsolution.efxclipse.gefx.scene.Scene scene =
	// SceneFactory.eINSTANCE.createScene();
	//
	// at.bestsolution.efxclipse.gefx.scene.Group root =
	// SceneFactory.eINSTANCE.createGroup();
	// scene.setRoot(root);
	//
	// at.bestsolution.efxclipse.gefx.scene.Rectangle rectangle =
	// SceneFactory.eINSTANCE.createRectangle();
	// rectangle.setX(10);
	// rectangle.setY(10);
	...
	//
	// Line line =
	// SceneFactory.eINSTANCE.createLine().from(ellipse).to(rectangle);
