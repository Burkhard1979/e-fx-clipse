...
/**
 * <p>Tabs are placed within a {@link FX8TabPane}, where each tab represents a single
 * 'page'.</p>
...
public class FX8Tab extends FXTab {
            ...
            selected = new ReadOnlyBooleanWrapper() {
                @Override protected void invalidated() {
                    if (getOnSelectionChanged() != null) {
                        Event.fireEvent(FX8Tab.this, new Event(SELECTION_CHANGED_EVENT));
                    }
                }
    ...
    private ReadOnlyObjectWrapper<FX8TabPane> tabPane;

    final void setTabPane(FX8TabPane value) {
     ...
     */
    public final FX8TabPane getTabPane() {
     ...
     */
    public final ReadOnlyObjectProperty<FX8TabPane> tabPaneProperty() {
        return tabPanePropertyImpl().getReadOnlyProperty();
    }

    private ReadOnlyObjectWrapper<FX8TabPane> tabPanePropertyImpl() {
        if (tabPane == null) {
            tabPane = new ReadOnlyObjectWrapper<FX8TabPane>(this, "tabPane");
        }
        return tabPane;
    }
     ...
     * can be selected using {@link FX8TabPane#getSelectionModel()}.
     * 
     * @defaultValue false
     * @since 2.2
     */
    ...
    public static final EventType<Event> CLOSE_REQUEST_EVENT = new EventType<Event> (Event.ANY, "TAB_CLOSE_REQUEST");
    /**
     * Called when there is an external request to close this {@code Tab}.
     * The installed event handler can prevent tab closing by setting {@link TabEvent#vetoOnCloseProperty()} 
     * to true
     */
    ...
    public final ObjectProperty<EventHandler<Event>> onCloseRequestProperty() {
        if( onCloseRequest == null ) {
            onCloseRequest = new ObjectPropertyBase<EventHandler<Event>>() {
                @Override protected void invalidated() {
                    setEventHandler(CLOSE_REQUEST_EVENT, get());
                }
    ...
    public void setOnCloseRequests(EventHandler<Event> value) {
     ...
     * be retrieved by calling {@link FX8Tab#getUserData()}.
     *
     * @param value The value to be stored - this can later be retrieved by calling
     *          {@link FX8Tab#getUserData()}.
     * @since 2.2
     */
     ...
     * has been set using the {@link FX8Tab#setUserData(java.lang.Object)} method.
     *
    ...
    public Styleable impl_getStyleable() {
        ...
        if (styleable == null) {
            styleable = new Styleable() {
                ...
                @Override
                public String getId() {
                    return FX8Tab.this.getId();
                }

                @Override
                public List<String> getStyleClass() {
                    return FX8Tab.this.getStyleClass();
                }

                @Override
                public String getStyle() {
                    return FX8Tab.this.getStyle();
                }
