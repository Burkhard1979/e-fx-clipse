...
import at.bestsolution.efxclipse.runtime.controls.fx8.FX8TabPane.TabClosingPolicy;
...
public class FX8TabPaneSkin extends SkinBase<FX8TabPane, FX8TabPaneBehavior> {
    ...
    private FX8Tab selectedTab;
    private FX8Tab previousSelectedTab;
    private boolean isSelectingTab;

    public FX8TabPaneSkin(FX8TabPane tabPane) {
        super(tabPane, new FX8TabPaneBehavior(tabPane));
        ...
        for (FX8Tab tab : getSkinnable().getTabs()) {
            addTabContent(tab);
        }
    ...
    private Map<FX8Tab, Timeline> closedTab = new HashMap();

    private void initializeTabListener() {
        getSkinnable().getTabs().addListener(new ListChangeListener<FX8Tab>() {
            @Override public void onChanged(final Change<? extends FX8Tab> c) {      
                while (c.next()) {
                    for (final FX8Tab tab : c.getRemoved()) {
                    ...
                    int i = 0;
                    for (final FX8Tab tab : c.getAddedSubList()) {
                        ...
                        if (closedTabTimeline != null) {
                            ...
                            Iterator<FX8Tab> keys = closedTab.keySet().iterator();
                            while (keys.hasNext()) {
                                FX8Tab key = keys.next();
                                if (tab.equals(key)) {
                                    removeTab(key);
                                    keys.remove();                                    
                                }
    ...
    private void addTabContent(FX8Tab tab) {
    ...
    private void removeTabContent(FX8Tab tab) {
        for (TabContentRegion contentRegion : tabContentRegions) {
    ...
    private void removeTab(FX8Tab tab) {
        final TabHeaderSkin tabRegion = tabHeaderArea.getTabHeaderSkin(tab);
    ...
    private boolean isFloatingStyleClass() {
        return getSkinnable().getStyleClass().contains(FX8TabPane.STYLE_CLASS_FLOATING);
    }
...
//    }
    ...
    @Override protected void layoutChildren(final double x, final double y,
        ...
        FX8TabPane tabPane = getSkinnable();
    ...
    class TabHeaderArea extends StackPane {
        ...
        public TabHeaderArea() {
            ...
            setManaged(false);
            final FX8TabPane tabPane = getSkinnable();
            ...
            int i = 0;
            for (FX8Tab tab: tabPane.getTabs()) {
                addTab(tab, i++, true);
            }
        ...
        private void addTab(FX8Tab tab, int addToIndex, boolean visible) {
        ...
        private TabHeaderSkin getTabHeaderSkin(FX8Tab tab) {
    ...
    class TabHeaderSkin extends StackPane {
        private final FX8Tab tab;
        public FX8Tab getTab() {
            return tab;
        }
        private Label label;
        ...
        public TabHeaderSkin(final FX8Tab tab) {
            ...
            closeBtn.setOnMousePressed(new EventHandler<MouseEvent>() {
                @Override public void handle(MouseEvent me) {
                    FX8Tab tab = getTab();
                    FX8TabPaneBehavior behavior = getBehavior();
...
//                            getChildren().addAll(tooltip);
            ...
            getProperties().put(FX8Tab.class, tab);
        ...
        private void removeListeners(FX8Tab tab) {
    ...
    class TabContentRegion extends StackPane implements TraverseListener {
        ...
        public TabContentRegion(FX8Tab tab) {
    ...
    class TabControlButtons extends StackPane {
        ...
        public TabControlButtons() {            
            ...
            tabPane.getTabs().addListener(new ListChangeListener<FX8Tab>() {
...
//                popup.setManaged(false);
            ...
            for (final FX8Tab tab : getSkinnable().getTabs()) {
    ...
    class TabMenuItem extends RadioMenuItem {
        FX8Tab tab;
        public TabMenuItem(final FX8Tab tab) {
            super(tab.getText(), FX8TabPaneSkin.clone(tab.getGraphic()));                        
            this.tab = tab;
