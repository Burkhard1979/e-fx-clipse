 ...
 * <ul>
 *   <li>{@link at.bestsolution.efxclipse.tooling.decora.decoraDsl.impl.initializerImpl#getE <em>E</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class initializerImpl extends MinimalEObjectImpl.Container implements initializer
{
  ...
  {
    return DecoraDslPackage.Literals.INITIALIZER;
  }
  ...
  public NotificationChain basicSetE(assignment_expression newE, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DecoraDslPackage.INITIALIZER__E, oldE, newE);
  ...
  public void setE(assignment_expression newE)
  {
    if (newE != e)
    {
      ...
      if (e != null)
        msgs = ((InternalEObject)e).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DecoraDslPackage.INITIALIZER__E, null, msgs);
      if (newE != null)
        msgs = ((InternalEObject)newE).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DecoraDslPackage.INITIALIZER__E, null, msgs);
      msgs = basicSetE(newE, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DecoraDslPackage.INITIALIZER__E, newE, newE));
  }
