 ...
 * <ul>
 *   <li>{@link at.bestsolution.efxclipse.tooling.decora.decoraDsl.impl.expression_statementImpl#getE <em>E</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class expression_statementImpl extends MinimalEObjectImpl.Container implements expression_statement
{
  ...
  {
    return DecoraDslPackage.Literals.EXPRESSION_STATEMENT;
  }
  ...
  public void setE(Expr newE)
  {
    if (newE != e)
    {
      ...
      if (e != null)
        msgs = ((InternalEObject)e).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DecoraDslPackage.EXPRESSION_STATEMENT__E, null, msgs);
      if (newE != null)
        msgs = ((InternalEObject)newE).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DecoraDslPackage.EXPRESSION_STATEMENT__E, null, msgs);
      msgs = basicSetE(newE, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DecoraDslPackage.EXPRESSION_STATEMENT__E, newE, newE));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case DecoraDslPackage.EXPRESSION_STATEMENT__E:
