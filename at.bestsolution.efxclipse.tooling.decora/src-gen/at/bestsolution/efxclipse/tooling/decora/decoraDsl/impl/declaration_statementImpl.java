 ...
 * <ul>
 *   <li>{@link at.bestsolution.efxclipse.tooling.decora.decoraDsl.impl.declaration_statementImpl#getD <em>D</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class declaration_statementImpl extends MinimalEObjectImpl.Container implements declaration_statement
{
  ...
  {
    return DecoraDslPackage.Literals.DECLARATION_STATEMENT;
  }
  ...
  public void setD(declaration newD)
  {
    if (newD != d)
    {
      ...
      if (d != null)
        msgs = ((InternalEObject)d).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DecoraDslPackage.DECLARATION_STATEMENT__D, null, msgs);
      if (newD != null)
        msgs = ((InternalEObject)newD).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DecoraDslPackage.DECLARATION_STATEMENT__D, null, msgs);
      msgs = basicSetD(newD, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DecoraDslPackage.DECLARATION_STATEMENT__D, newD, newD));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case DecoraDslPackage.DECLARATION_STATEMENT__D:
