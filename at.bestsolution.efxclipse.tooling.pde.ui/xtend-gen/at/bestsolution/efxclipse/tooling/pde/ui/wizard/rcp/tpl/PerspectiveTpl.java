...
public class PerspectiveTpl implements Generator<DynamicFile> {
  ...
  public CharSequence generate(final String packageName) {
    ...
    _builder.newLine();
    _builder.append("import $packageName$.$viewPartClass$;");
    _builder.newLine();
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("layout.addStandaloneView($viewPartClass$.ID, false, IPageLayout.LEFT, 1.0f, layout.getEditorArea());");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("}");
    _builder.newLine();
