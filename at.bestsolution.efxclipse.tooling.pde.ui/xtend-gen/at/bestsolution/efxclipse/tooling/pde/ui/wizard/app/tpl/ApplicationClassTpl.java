...
public class ApplicationClassTpl implements Generator<DynamicFile> {
  ...
  public CharSequence generate(final String packageName) {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("import at.bestsolution.efxclipse.runtime.application.AbstractJFXApplication;");
    _builder.newLine();
    _builder.newLine();
    _builder.append("public class MainApplication extends AbstractJFXApplication {");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("protected void jfxStart(IApplicationContext applicationContext, Application jfxApplication, Stage primaryStage) {");
    _builder.newLine();
    _builder.append("\t\t");
