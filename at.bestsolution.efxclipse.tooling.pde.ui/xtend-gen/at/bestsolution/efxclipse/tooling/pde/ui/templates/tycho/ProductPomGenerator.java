...
public class ProductPomGenerator implements Generator<DynamicFile> {
  ...
  public CharSequence generate(final PomData data) {
    ...
    _builder.newLine();
    _builder.append("      \t\t");
    _builder.append("<artifactId>tycho-p2-director-plugin</artifactId>");
    _builder.newLine();
    _builder.append("      \t\t");
    ...
    _builder.newLine();
    _builder.append("          \t\t\t");
    _builder.append("<id>materialize-products</id>");
    _builder.newLine();
    _builder.append("          \t\t\t");
    _builder.append("<goals>");
    _builder.newLine();
    _builder.append("            \t\t\t");
    _builder.append("<goal>materialize-products</goal>");
    _builder.newLine();
    _builder.append("          \t\t\t");
    _builder.append("</goals>");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("          \t\t\t");
    _builder.append("<id>archive-products</id>");
    _builder.newLine();
    _builder.append("          \t\t\t");
    _builder.append("<goals>");
    _builder.newLine();
    _builder.append("            \t\t\t");
    _builder.append("<goal>archive-products</goal>");
    _builder.newLine();
    _builder.append("          \t\t\t");
    _builder.append("</goals>");
    _builder.newLine();
