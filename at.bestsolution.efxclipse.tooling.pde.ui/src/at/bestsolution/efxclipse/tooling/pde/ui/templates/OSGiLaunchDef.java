...
public class OSGiLaunchDef extends BasicLaunchDef {
	public static Set<PluginLaunchDef> getTargetDefinitions() {
		...
		set.add(PluginLaunchDef.parse("at.bestsolution.efxclipse.runtime.application@default:default"));
		set.add(PluginLaunchDef.parse("at.bestsolution.efxclipse.runtime.databinding@default:default"));
		set.add(PluginLaunchDef.parse("at.bestsolution.efxclipse.runtime.javafx@default:default"));
		set.add(PluginLaunchDef.parse("at.bestsolution.efxclipse.runtime.osgi@default:false"));
