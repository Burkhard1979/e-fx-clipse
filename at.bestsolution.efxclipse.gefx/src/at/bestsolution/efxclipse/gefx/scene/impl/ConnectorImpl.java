 ...
 * <ul>
 *   <li>{@link at.bestsolution.efxclipse.gefx.scene.impl.ConnectorImpl#getBlock <em>Block</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.gefx.scene.impl.ConnectorImpl#getRotation <em>Rotation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ConnectorImpl extends ShapeImpl implements Connector {
	...
	public NotificationChain basicSetBlock(Block newBlock, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newBlock, ScenePackage.CONNECTOR__BLOCK, msgs);
		return msgs;
	}
	...
	public void setBlock(Block newBlock) {
		if (newBlock != eInternalContainer() || (eContainerFeatureID() != ScenePackage.CONNECTOR__BLOCK && newBlock != null)) {
			...
			if (newBlock != null)
				msgs = ((InternalEObject)newBlock).eInverseAdd(this, ScenePackage.BLOCK__CONNECTORS, Block.class, msgs);
			msgs = basicSetBlock(newBlock, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ScenePackage.CONNECTOR__BLOCK, newBlock, newBlock));
	}
	...
	public void setRotation(double newRotation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ScenePackage.CONNECTOR__ROTATION, oldRotation, rotation));
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case ScenePackage.CONNECTOR__BLOCK:
				return eInternalContainer().eInverseRemove(this, ScenePackage.BLOCK__CONNECTORS, Block.class, msgs);
		}
