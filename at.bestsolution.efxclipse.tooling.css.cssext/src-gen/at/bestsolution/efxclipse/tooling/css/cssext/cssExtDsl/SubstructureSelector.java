 ...
 * </p>
 *
 * @see at.bestsolution.efxclipse.tooling.css.cssext.cssExtDsl.CssExtDslPackage#getSubstructureSelector()
 * @model
 * @generated
 */
public interface SubstructureSelector extends EObject
{
   ...
   * @see #setVar(String)
   * @see at.bestsolution.efxclipse.tooling.css.cssext.cssExtDsl.CssExtDslPackage#getSubstructureSelector_Var()
   * @model
   * @generated
   */
  String getVar();
  ...
  /**
   * Sets the value of the '{@link at.bestsolution.efxclipse.tooling.css.cssext.cssExtDsl.SubstructureSelector#getVar <em>Var</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
