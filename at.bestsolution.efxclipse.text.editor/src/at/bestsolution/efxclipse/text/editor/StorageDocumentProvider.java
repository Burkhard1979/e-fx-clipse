...
public class StorageDocumentProvider extends AbstractDocumentProvider implements IStorageDocumentProvider {
	...
	protected void setDocumentContent(IDocument document, InputStream contentStream, String encoding) throws CoreException {
		...
		try {
			...
			IStatus s= new Status(IStatus.ERROR, TextEditorPlugin.PLUGIN_ID, IStatus.OK, message, x);
		...
		if (element instanceof IStorageEditorInput) {
			...
			if (info != null) {
				...
				try {
					...
					TextEditorPlugin.log(ex.getStatus());
				}
			}
		}
	}
	...
	public IContentType getContentType(Object element) throws CoreException {
		if (element instanceof IStorageEditorInput) {
			...
			try {
				...
				throw new CoreException(new Status(IStatus.ERROR, TextEditorPlugin.PLUGIN_ID, IStatus.OK, message, x));
			} finally {
				try {
