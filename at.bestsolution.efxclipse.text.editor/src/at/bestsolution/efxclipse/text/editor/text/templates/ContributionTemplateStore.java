...
import at.bestsolution.efxclipse.text.jface.templates.persistence.TemplatePersistenceData;
import at.bestsolution.efxclipse.text.jface.templates.persistence.TemplateReaderWriter;
	...
	private boolean validateTemplate(Template template) {
		...
		if (getRegistry() != null) {
			try {
				...
				TextEditorPlugin.log(MessageFormat.format(ContributionTemplateMessages.ContributionTemplateStore_ignore_validation_failed, template.getName()), e);
				return false;
			}
		}
		return true;
