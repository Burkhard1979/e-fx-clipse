...
public class MarkerAnnotationPreferences {
	...
	public static void initializeDefaultValues(IPreferenceStore store) { 
		...
		MarkerAnnotationPreferences preferences= TextEditorPlugin.getDefault().getMarkerAnnotationPreferences();
...
//			throw new IllegalStateException();
	...
	private void initialize() {
		synchronized (TextEditorPlugin.getDefault()) {
			if (!TextEditorPlugin.getDefault().isMarkerAnnotationPreferencesInitialized())
				TextEditorPlugin.getDefault().setMarkerAnnotationPreferences(new MarkerAnnotationPreferences(true));
		}

		MarkerAnnotationPreferences sharedPrefs= TextEditorPlugin.getDefault().getMarkerAnnotationPreferences();
	...
	private void initializeSharedMakerAnnotationPreferences() {
		...
		// populate list
		IExtensionPoint extensionPoint= Platform.getExtensionRegistry().getExtensionPoint(TextEditorPlugin.PLUGIN_ID, "markerAnnotationSpecification"); //$NON-NLS-1$
