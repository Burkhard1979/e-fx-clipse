...
public class FX2Tab extends FXTab {
            ...
            selected = new ReadOnlyBooleanWrapper() {
                @Override protected void invalidated() {
                    if (getOnSelectionChanged() != null) {
                        Event.fireEvent(FX2Tab.this, new Event(SELECTION_CHANGED_EVENT));
                    }
                }
    ...
    private ReadOnlyObjectWrapper<FX2TabPane> tabPane;

    final void setTabPane(FX2TabPane value) {
     ...
     */
    public final FX2TabPane getTabPane() {
     ...
     */
    public final ReadOnlyObjectProperty<FX2TabPane> tabPaneProperty() {
        return tabPanePropertyImpl().getReadOnlyProperty();
    }

    private ReadOnlyObjectWrapper<FX2TabPane> tabPanePropertyImpl() {
        if (tabPane == null) {
            tabPane = new ReadOnlyObjectWrapper<FX2TabPane>(this, "tabPane");
        }
        return tabPane;
    }
     ...
     * can be selected using {@link FX2TabPane#getSelectionModel()}.
     * 
     * @defaultValue false
     * @since 2.2
     */
     ...
     * be retrieved by calling {@link FX2Tab#getUserData()}.
     *
     * @param value The value to be stored - this can later be retrieved by calling
     *          {@link FX2Tab#getUserData()}.
     * @since 2.2
     */
     ...
     * has been set using the {@link FX2Tab#setUserData(java.lang.Object)} method.
     *
    ...
    public Styleable impl_getStyleable() {
        ...
        if (styleable == null) {
            styleable = new Styleable() {
                ...
                @Override
                public String getId() {
                    return FX2Tab.this.getId();
                }

                @Override
                public List<String> getStyleClass() {
                    return FX2Tab.this.getStyleClass();
                }

                @Override
                public String getStyle() {
                    return FX2Tab.this.getStyle();
                }
