		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getPseudoClassAccess().getAlternatives(), "rule__PseudoClass__Alternatives");
					...
					put(grammarAccess.getColorTokAccess().getColorAlternatives_2_0(), "rule__ColorTok__ColorAlternatives_2_0");
					put(grammarAccess.getCssTokAccess().getAlternatives(), "rule__CssTok__Alternatives");
					put(grammarAccess.getSignedNumAccess().getAlternatives_1(), "rule__SignedNum__Alternatives_1");
					...
					put(grammarAccess.getPseudoClassAccess().getGroup_0(), "rule__PseudoClass__Group_0__0");
					put(grammarAccess.getPseudoClassFunctionAccess().getGroup(), "rule__PseudoClassFunction__Group__0");
					...
					put(grammarAccess.getFuncTokAccess().getGroup(), "rule__FuncTok__Group__0");
					put(grammarAccess.getNumberTokAccess().getGroup(), "rule__NumberTok__Group__0");
					put(grammarAccess.getIdentifierTokAccess().getGroup(), "rule__IdentifierTok__Group__0");
					...
					put(grammarAccess.getSignedNumAccess().getGroup(), "rule__SignedNum__Group__0");
					put(grammarAccess.getSignedNumAccess().getGroup_1_1(), "rule__SignedNum__Group_1_1__0");
					...
					put(grammarAccess.getUniversalSelectorAccess().getNamespeceAssignment_1(), "rule__UniversalSelector__NamespeceAssignment_1");
					...
					put(grammarAccess.getPseudoClassFunctionAccess().getNameAssignment_0(), "rule__PseudoClassFunction__NameAssignment_0");
					put(grammarAccess.getPseudoClassFunctionAccess().getParamsAssignment_2(), "rule__PseudoClassFunction__ParamsAssignment_2");
					...
					put(grammarAccess.getFuncTokAccess().getFuncAssignment_1(), "rule__FuncTok__FuncAssignment_1");
					put(grammarAccess.getNumberTokAccess().getNumAssignment_1(), "rule__NumberTok__NumAssignment_1");
					put(grammarAccess.getNumberTokAccess().getUnitAssignment_2(), "rule__NumberTok__UnitAssignment_2");
					put(grammarAccess.getIdentifierTokAccess().getIdAssignment_1(), "rule__IdentifierTok__IdAssignment_1");
					put(grammarAccess.getUrlTokAccess().getUrlAssignment_1(), "rule__UrlTok__UrlAssignment_1");
					put(grammarAccess.getColorTokAccess().getColorAssignment_2(), "rule__ColorTok__ColorAssignment_2");
