	...
	public void earlyStartup() {
		...
		if(minVersion.compareTo(realVersion) == 1 ) {
			StatusManager.getManager().handle(
					new Status(IStatus.ERROR, "at.bestsolution.efxclipse.tooling.java6", "You are not running your eclipse instance with Java7 or Java8. The JavaFX tooling is disabled because of this."),StatusManager.SHOW);
		}
	}
