...
public class FXTabPaneBehavior extends BehaviorBase<FXTabPane> {
    ...
    @Override protected void callAction(String name) {
        if ("TraverseLeft".equals(name) ||
            ...
            FXTabPane tp = getControl();
            FXTabPaneSkin tps = (FXTabPaneSkin)tp.getSkin();
    ...
    public FXTabPaneBehavior(FXTabPane tabPane) {
        super(tabPane);
    }

    public void selectTab(FXTab tab) {
        getControl().getSelectionModel().select(tab);
    }

    public boolean canCloseTab(FXTab tab) {
    ...
    public void closeTab(FXTab tab) {
        FXTabPane tabPane = getControl();
        ...
        if (tab.getOnClosed() != null) {
            Event.fireEvent(tab, new Event(FXTab.CLOSED_EVENT));
        }
    }

    // Find a tab after the currently selected that is not disabled.
    public void selectNextTab() {
        SingleSelectionModel<FXTab> selectionModel = getControl().getSelectionModel();
