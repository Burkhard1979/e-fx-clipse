...
* generated by Xtext
*/
package at.bestsolution.efxclipse.tooling.efxbean.ui.contentassist.antlr;
...
public class FXBeanParser extends AbstractContentAssistParser {
	...
	@Override
	protected at.bestsolution.efxclipse.tooling.efxbean.ui.contentassist.antlr.internal.InternalFXBeanParser createParser() {
		at.bestsolution.efxclipse.tooling.efxbean.ui.contentassist.antlr.internal.InternalFXBeanParser result = new at.bestsolution.efxclipse.tooling.efxbean.ui.contentassist.antlr.internal.InternalFXBeanParser(null);
	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getBeanAccess().getAlternatives_5(), "rule__Bean__Alternatives_5");
					...
					put(grammarAccess.getMultiplicityAccess().getAlternatives_1_1_2(), "rule__Multiplicity__Alternatives_1_1_2");
					...
					put(grammarAccess.getFXBeanUnitAccess().getGroup(), "rule__FXBeanUnit__Group__0");
					put(grammarAccess.getPackageDeclarationAccess().getGroup(), "rule__PackageDeclaration__Group__0");
					put(grammarAccess.getImportAccess().getGroup(), "rule__Import__Group__0");
					put(grammarAccess.getBeanAccess().getGroup(), "rule__Bean__Group__0");
					put(grammarAccess.getBeanAccess().getGroup_3(), "rule__Bean__Group_3__0");
					put(grammarAccess.getBeanPropertyDeclAccess().getGroup(), "rule__BeanPropertyDecl__Group__0");
					put(grammarAccess.getBeanAttributeDeclAccess().getGroup(), "rule__BeanAttributeDecl__Group__0");
					put(grammarAccess.getValueListTypeDefAccess().getGroup(), "rule__ValueListTypeDef__Group__0");
					put(grammarAccess.getMapTypeDefAccess().getGroup(), "rule__MapTypeDef__Group__0");
					put(grammarAccess.getMultiplicityAccess().getGroup(), "rule__Multiplicity__Group__0");
					put(grammarAccess.getMultiplicityAccess().getGroup_1_1(), "rule__Multiplicity__Group_1_1__0");
					...
					put(grammarAccess.getFXBeanUnitAccess().getPackageAssignment_0(), "rule__FXBeanUnit__PackageAssignment_0");
					put(grammarAccess.getFXBeanUnitAccess().getImportsAssignment_1(), "rule__FXBeanUnit__ImportsAssignment_1");
					put(grammarAccess.getFXBeanUnitAccess().getBeanAssignment_2(), "rule__FXBeanUnit__BeanAssignment_2");
					...
					put(grammarAccess.getBeanAccess().getReflectiveAssignment_0(), "rule__Bean__ReflectiveAssignment_0");
					put(grammarAccess.getBeanAccess().getNameAssignment_2(), "rule__Bean__NameAssignment_2");
					put(grammarAccess.getBeanAccess().getSuperTypeAssignment_3_1(), "rule__Bean__SuperTypeAssignment_3_1");
					put(grammarAccess.getBeanAccess().getPropertiesAssignment_5_0(), "rule__Bean__PropertiesAssignment_5_0");
					put(grammarAccess.getBeanAccess().getAttributesAssignment_5_1(), "rule__Bean__AttributesAssignment_5_1");
					put(grammarAccess.getBeanPropertyDeclAccess().getReadonlyAssignment_0(), "rule__BeanPropertyDecl__ReadonlyAssignment_0");
					put(grammarAccess.getBeanPropertyDeclAccess().getLazyAssignment_1(), "rule__BeanPropertyDecl__LazyAssignment_1");
					put(grammarAccess.getBeanPropertyDeclAccess().getReferenceAssignment_2(), "rule__BeanPropertyDecl__ReferenceAssignment_2");
					put(grammarAccess.getBeanPropertyDeclAccess().getTypeAssignment_4(), "rule__BeanPropertyDecl__TypeAssignment_4");
					put(grammarAccess.getBeanPropertyDeclAccess().getNameAssignment_5(), "rule__BeanPropertyDecl__NameAssignment_5");
					put(grammarAccess.getBeanAttributeDeclAccess().getReadonlyAssignment_0(), "rule__BeanAttributeDecl__ReadonlyAssignment_0");
					put(grammarAccess.getBeanAttributeDeclAccess().getLazyAssignment_1(), "rule__BeanAttributeDecl__LazyAssignment_1");
					put(grammarAccess.getBeanAttributeDeclAccess().getReferenceAssignment_2(), "rule__BeanAttributeDecl__ReferenceAssignment_2");
					put(grammarAccess.getBeanAttributeDeclAccess().getTypeAssignment_4(), "rule__BeanAttributeDecl__TypeAssignment_4");
					put(grammarAccess.getValueListTypeDefAccess().getSingleTypeAssignment_0(), "rule__ValueListTypeDef__SingleTypeAssignment_0");
					put(grammarAccess.getValueListTypeDefAccess().getMultiAssignment_1(), "rule__ValueListTypeDef__MultiAssignment_1");
					put(grammarAccess.getMapTypeDefAccess().getKeyTypeAssignment_1(), "rule__MapTypeDef__KeyTypeAssignment_1");
					put(grammarAccess.getMapTypeDefAccess().getValueTypeAssignment_3(), "rule__MapTypeDef__ValueTypeAssignment_3");
					put(grammarAccess.getMultiplicityAccess().getTotalUnboundAssignment_1_0(), "rule__Multiplicity__TotalUnboundAssignment_1_0");
					put(grammarAccess.getMultiplicityAccess().getLowerBoundAssignment_1_1_0(), "rule__Multiplicity__LowerBoundAssignment_1_1_0");
					put(grammarAccess.getMultiplicityAccess().getUpperBoundAssignment_1_1_2_0(), "rule__Multiplicity__UpperBoundAssignment_1_1_2_0");
					put(grammarAccess.getMultiplicityAccess().getNoUpperBoundAssignment_1_1_2_1(), "rule__Multiplicity__NoUpperBoundAssignment_1_1_2_1");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			at.bestsolution.efxclipse.tooling.efxbean.ui.contentassist.antlr.internal.InternalFXBeanParser typedParser = (at.bestsolution.efxclipse.tooling.efxbean.ui.contentassist.antlr.internal.InternalFXBeanParser) parser;
			typedParser.entryRuleFXBeanUnit();
