	...
	public void setResolvedInstance(SvgElement newResolvedInstance) {
		if (newResolvedInstance != resolvedInstance) {
			...
			if (resolvedInstance != null)
				msgs = ((InternalEObject)resolvedInstance).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SvgPackage.SVG_RADIAL_GRADIENT_ELEMENT__RESOLVED_INSTANCE, null, msgs);
			if (newResolvedInstance != null)
				msgs = ((InternalEObject)newResolvedInstance).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SvgPackage.SVG_RADIAL_GRADIENT_ELEMENT__RESOLVED_INSTANCE, null, msgs);
			msgs = basicSetResolvedInstance(newResolvedInstance, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_RADIAL_GRADIENT_ELEMENT__RESOLVED_INSTANCE, newResolvedInstance, newResolvedInstance));
	}
