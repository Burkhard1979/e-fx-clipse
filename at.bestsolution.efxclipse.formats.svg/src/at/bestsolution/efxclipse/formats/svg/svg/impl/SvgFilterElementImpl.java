...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Filter Element</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getId <em>Id</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getXml__base <em>Xml base</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getXml__lang <em>Xml lang</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getXml__space <em>Xml space</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getAlignment_baseline <em>Alignment baseline</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getBaseline_shift <em>Baseline shift</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getClip <em>Clip</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getClip_path <em>Clip path</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getClip_rule <em>Clip rule</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getColor <em>Color</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getColor_interpolation <em>Color interpolation</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getColor_interpolation_filters <em>Color interpolation filters</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getColor_profile <em>Color profile</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getColor_rendering <em>Color rendering</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getCursor <em>Cursor</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getDirection <em>Direction</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getDisplay <em>Display</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getDominant_baseline <em>Dominant baseline</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getEnable_background <em>Enable background</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getFill <em>Fill</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getFill_opacity <em>Fill opacity</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getFill_rule <em>Fill rule</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getFilter <em>Filter</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getFlood_color <em>Flood color</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getFlood_opacity <em>Flood opacity</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getFont_family <em>Font family</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getFont_size <em>Font size</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getFont_size_adjust <em>Font size adjust</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getFont_stretch <em>Font stretch</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getFont_style <em>Font style</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getFont_variant <em>Font variant</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getFont_weight <em>Font weight</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getGlyph_orientation_horizontal <em>Glyph orientation horizontal</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getGlyph_orientation_vertical <em>Glyph orientation vertical</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getImage_rendering <em>Image rendering</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getKerning <em>Kerning</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getLetter_spacing <em>Letter spacing</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getLighting_color <em>Lighting color</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getMarker_end <em>Marker end</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getMarker_mid <em>Marker mid</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getMarker_start <em>Marker start</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getMasks <em>Masks</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getOpacity <em>Opacity</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getOverflow <em>Overflow</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getPointer_events <em>Pointer events</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getShape_rendering <em>Shape rendering</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getStop_color <em>Stop color</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getStop_opacity <em>Stop opacity</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getStroke <em>Stroke</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getStroke_dasharray <em>Stroke dasharray</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getStroke_dashoffset <em>Stroke dashoffset</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getStroke_linecap <em>Stroke linecap</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getStroke_linejoin <em>Stroke linejoin</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getStroke_miterlimit <em>Stroke miterlimit</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getStroke_opacity <em>Stroke opacity</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getStroke_width <em>Stroke width</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getText_anchor <em>Text anchor</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getText_decoration <em>Text decoration</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getText_rendering <em>Text rendering</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getUnicode_bidi <em>Unicode bidi</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getVisibility <em>Visibility</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getWord_spacing <em>Word spacing</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getWriting_mode <em>Writing mode</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getXlink__href <em>Xlink href</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getXlink__show <em>Xlink show</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getXlink__actuate <em>Xlink actuate</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getXlink__type <em>Xlink type</em>}</li>
 ...
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getExternalResourcesRequired <em>External Resources Required</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getX <em>X</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getY <em>Y</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getWidth <em>Width</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getHeight <em>Height</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getFilterRes <em>Filter Res</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getFilterUnits <em>Filter Units</em>}</li>
 *   <li>{@link at.bestsolution.efxclipse.formats.svg.svg.impl.SvgFilterElementImpl#getPrimitiveUnits <em>Primitive Units</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class SvgFilterElementImpl extends EObjectImpl implements SvgFilterElement {
	/**
	...
	/**
	 * The default value of the '{@link #getFilterRes() <em>Filter Res</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getFilterRes()
	 * @generated
	 * @ordered
	 */
	protected static final String FILTER_RES_EDEFAULT = null;

	/**
	 * The cached value of the '{@link #getFilterRes() <em>Filter Res</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getFilterRes()
	 * @generated
	 * @ordered
	 */
	protected String filterRes = FILTER_RES_EDEFAULT;

	/**
	 * The default value of the '{@link #getFilterUnits() <em>Filter Units</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getFilterUnits()
	 * @generated
	 * @ordered
	 */
	protected static final FilterUnits FILTER_UNITS_EDEFAULT = FilterUnits.USER_SPACE_ON_USE;

	/**
	 * The cached value of the '{@link #getFilterUnits() <em>Filter Units</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getFilterUnits()
	 * @generated
	 * @ordered
	 */
	protected FilterUnits filterUnits = FILTER_UNITS_EDEFAULT;

	/**
	 * The default value of the '{@link #getPrimitiveUnits() <em>Primitive Units</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
	protected static final FilterUnits PRIMITIVE_UNITS_EDEFAULT = FilterUnits.USER_SPACE_ON_USE;

	/**
	 * The cached value of the '{@link #getPrimitiveUnits() <em>Primitive Units</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getPrimitiveUnits()
	 * @generated
	 * @ordered
	 */
	protected FilterUnits primitiveUnits = PRIMITIVE_UNITS_EDEFAULT;
	 ...
	 * @generated
	 */
	protected SvgFilterElementImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return SvgPackage.Literals.SVG_FILTER_ELEMENT;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__ID, oldId, id));
	}
	...
	public void setXml__base(String newXml__base) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__XML_BASE, oldXml__base, xml__base));
	}
	...
	public void setXml__lang(String newXml__lang) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__XML_LANG, oldXml__lang, xml__lang));
	}
	...
	public void setXml__space(String newXml__space) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__XML_SPACE, oldXml__space, xml__space));
	}
	...
	public void setAlignment_baseline(Alignment_baseline newAlignment_baseline) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__ALIGNMENT_BASELINE, oldAlignment_baseline, alignment_baseline));
	}
	...
	public void setBaseline_shift(String newBaseline_shift) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__BASELINE_SHIFT, oldBaseline_shift, baseline_shift));
	}
	...
	public void setClip(String newClip) {
		...
		clip = newClip;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__CLIP, oldClip, clip));
	}
	...
	public void setClip_path(String newClip_path) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__CLIP_PATH, oldClip_path, clip_path));
	}
	...
	public void setClip_rule(Clip_rule newClip_rule) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__CLIP_RULE, oldClip_rule, clip_rule));
	}
	...
	public void setColor(String newColor) {
		...
		color = newColor;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__COLOR, oldColor, color));
	}
	...
	public void setColor_interpolation(Color_interpolation newColor_interpolation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__COLOR_INTERPOLATION, oldColor_interpolation, color_interpolation));
	}
	...
	public void setColor_interpolation_filters(Color_interpolation_filters newColor_interpolation_filters) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__COLOR_INTERPOLATION_FILTERS, oldColor_interpolation_filters, color_interpolation_filters));
	}
	...
	public void setColor_profile(String newColor_profile) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__COLOR_PROFILE, oldColor_profile, color_profile));
	}
	...
	public void setColor_rendering(Color_rendering newColor_rendering) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__COLOR_RENDERING, oldColor_rendering, color_rendering));
	}
	...
	public void setCursor(String newCursor) {
		...
		cursor = newCursor;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__CURSOR, oldCursor, cursor));
	}
	...
	public void setDirection(Direction newDirection) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__DIRECTION, oldDirection, direction));
	}
	...
	public void setDisplay(Display newDisplay) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__DISPLAY, oldDisplay, display));
	}
	...
	public void setDominant_baseline(Dominant_baseline newDominant_baseline) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__DOMINANT_BASELINE, oldDominant_baseline, dominant_baseline));
	}
	...
	public void setEnable_background(String newEnable_background) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__ENABLE_BACKGROUND, oldEnable_background, enable_background));
	}
	...
	public void setFill(String newFill) {
		...
		fill = newFill;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__FILL, oldFill, fill));
	}
	...
	public void setFill_opacity(String newFill_opacity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__FILL_OPACITY, oldFill_opacity, fill_opacity));
	}
	...
	public void setFill_rule(Fill_rule newFill_rule) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__FILL_RULE, oldFill_rule, fill_rule));
	}
	...
	public void setFilter(String newFilter) {
		...
		filter = newFilter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__FILTER, oldFilter, filter));
	}
	...
	public void setFlood_color(String newFlood_color) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__FLOOD_COLOR, oldFlood_color, flood_color));
	}
	...
	public void setFlood_opacity(String newFlood_opacity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__FLOOD_OPACITY, oldFlood_opacity, flood_opacity));
	}
	...
	public void setFont_family(String newFont_family) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__FONT_FAMILY, oldFont_family, font_family));
	}
	...
	public void setFont_size(String newFont_size) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__FONT_SIZE, oldFont_size, font_size));
	}
	...
	public void setFont_size_adjust(String newFont_size_adjust) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__FONT_SIZE_ADJUST, oldFont_size_adjust, font_size_adjust));
	}
	...
	public void setFont_style(Font_style newFont_style) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__FONT_STYLE, oldFont_style, font_style));
	}
	...
	public void setFont_variant(Font_variant newFont_variant) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__FONT_VARIANT, oldFont_variant, font_variant));
	}
	...
	public void setFont_weight(Font_weight newFont_weight) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__FONT_WEIGHT, oldFont_weight, font_weight));
	}
	...
	public void setGlyph_orientation_horizontal(String newGlyph_orientation_horizontal) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__GLYPH_ORIENTATION_HORIZONTAL, oldGlyph_orientation_horizontal, glyph_orientation_horizontal));
	}
	...
	public void setGlyph_orientation_vertical(String newGlyph_orientation_vertical) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__GLYPH_ORIENTATION_VERTICAL, oldGlyph_orientation_vertical, glyph_orientation_vertical));
	}
	...
	public void setImage_rendering(Image_rendering newImage_rendering) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__IMAGE_RENDERING, oldImage_rendering, image_rendering));
	}
	...
	public void setKerning(String newKerning) {
		...
		kerning = newKerning;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__KERNING, oldKerning, kerning));
	}
	...
	public void setLetter_spacing(String newLetter_spacing) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__LETTER_SPACING, oldLetter_spacing, letter_spacing));
	}
	...
	public void setLighting_color(String newLighting_color) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__LIGHTING_COLOR, oldLighting_color, lighting_color));
	}
	...
	public void setMarker_end(String newMarker_end) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__MARKER_END, oldMarker_end, marker_end));
	}
	...
	public void setMarker_mid(String newMarker_mid) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__MARKER_MID, oldMarker_mid, marker_mid));
	}
	...
	public void setMarker_start(String newMarker_start) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__MARKER_START, oldMarker_start, marker_start));
	}
	...
	public void setMasks(String newMasks) {
		...
		masks = newMasks;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__MASKS, oldMasks, masks));
	}
	...
	public void setOpacity(String newOpacity) {
		...
		opacity = newOpacity;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__OPACITY, oldOpacity, opacity));
	}
	...
	public void setPointer_events(Pointer_events newPointer_events) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__POINTER_EVENTS, oldPointer_events, pointer_events));
	}
	...
	public void setShape_rendering(Shape_rendering newShape_rendering) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__SHAPE_RENDERING, oldShape_rendering, shape_rendering));
	}
	...
	public void setStop_color(String newStop_color) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__STOP_COLOR, oldStop_color, stop_color));
	}
	...
	public void setStop_opacity(String newStop_opacity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__STOP_OPACITY, oldStop_opacity, stop_opacity));
	}
	...
	public void setStroke(String newStroke) {
		...
		stroke = newStroke;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__STROKE, oldStroke, stroke));
	}
	...
	public void setStroke_dasharray(String newStroke_dasharray) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__STROKE_DASHARRAY, oldStroke_dasharray, stroke_dasharray));
	}
	...
	public void setStroke_dashoffset(String newStroke_dashoffset) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__STROKE_DASHOFFSET, oldStroke_dashoffset, stroke_dashoffset));
	}
	...
	public void setStroke_linecap(Stroke_linecap newStroke_linecap) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__STROKE_LINECAP, oldStroke_linecap, stroke_linecap));
	}
	...
	public void setStroke_linejoin(Stroke_linejoin newStroke_linejoin) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__STROKE_LINEJOIN, oldStroke_linejoin, stroke_linejoin));
	}
	...
	public void setStroke_miterlimit(String newStroke_miterlimit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__STROKE_MITERLIMIT, oldStroke_miterlimit, stroke_miterlimit));
	}
	...
	public void setStroke_opacity(String newStroke_opacity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__STROKE_OPACITY, oldStroke_opacity, stroke_opacity));
	}
	...
	public void setStroke_width(String newStroke_width) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__STROKE_WIDTH, oldStroke_width, stroke_width));
	}
	...
	public void setText_anchor(Text_anchor newText_anchor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__TEXT_ANCHOR, oldText_anchor, text_anchor));
	}
	...
	public void setText_decoration(String newText_decoration) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__TEXT_DECORATION, oldText_decoration, text_decoration));
	}
	...
	public void setText_rendering(Text_rendering newText_rendering) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__TEXT_RENDERING, oldText_rendering, text_rendering));
	}
	...
	public void setUnicode_bidi(Unicode_bidi newUnicode_bidi) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__UNICODE_BIDI, oldUnicode_bidi, unicode_bidi));
	}
	...
	public void setVisibility(Visibility newVisibility) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__VISIBILITY, oldVisibility, visibility));
	}
	...
	public void setWord_spacing(String newWord_spacing) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__WORD_SPACING, oldWord_spacing, word_spacing));
	}
	...
	public void setWriting_mode(Writing_mode newWriting_mode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__WRITING_MODE, oldWriting_mode, writing_mode));
	}
	...
	public void setXlink__href(String newXlink__href) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__XLINK_HREF, oldXlink__href, xlink__href));
	}
	...
	public void setXlink__show(String newXlink__show) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__XLINK_SHOW, oldXlink__show, xlink__show));
	}
	...
	public void setXlink__actuate(String newXlink__actuate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__XLINK_ACTUATE, oldXlink__actuate, xlink__actuate));
	}
	...
	public void setXlink__type(String newXlink__type) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__XLINK_TYPE, oldXlink__type, xlink__type));
	}
	...
	public void setXlink__role(String newXlink__role) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__XLINK_ROLE, oldXlink__role, xlink__role));
	}
	...
	public void setXlink__arcrole(String newXlink__arcrole) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__XLINK_ARCROLE, oldXlink__arcrole, xlink__arcrole));
	}
	...
	public void setXlink__title(String newXlink__title) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__XLINK_TITLE, oldXlink__title, xlink__title));
	}
	...
	public void setResolvedInstance(SvgElement newResolvedInstance) {
		if (newResolvedInstance != resolvedInstance) {
			...
			if (resolvedInstance != null)
				msgs = ((InternalEObject)resolvedInstance).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SvgPackage.SVG_FILTER_ELEMENT__RESOLVED_INSTANCE, null, msgs);
			if (newResolvedInstance != null)
				msgs = ((InternalEObject)newResolvedInstance).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SvgPackage.SVG_FILTER_ELEMENT__RESOLVED_INSTANCE, null, msgs);
			msgs = basicSetResolvedInstance(newResolvedInstance, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__RESOLVED_INSTANCE, newResolvedInstance, newResolvedInstance));
	}
	...
	public void setClass(String newClass) {
		...
		class_ = newClass;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__CLASS, oldClass, class_));
	}
	...
	public void setStyle(String newStyle) {
		...
		style = newStyle;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__STYLE, oldStyle, style));
	}
	...
	public void setExternalResourcesRequired(String newExternalResourcesRequired) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__EXTERNAL_RESOURCES_REQUIRED, oldExternalResourcesRequired, externalResourcesRequired));
	}
	...
	public void setX(String newX) {
		...
		x = newX;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__X, oldX, x));
	}
	...
	public void setY(String newY) {
		...
		y = newY;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__Y, oldY, y));
	}
	...
	public void setWidth(String newWidth) {
		...
		width = newWidth;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__WIDTH, oldWidth, width));
	}
	...
	public void setHeight(String newHeight) {
		...
		height = newHeight;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__HEIGHT, oldHeight, height));
	}
	 ...
	 * @generated
	 */
	public void setFilterRes(String newFilterRes) {
		String oldFilterRes = filterRes;
		filterRes = newFilterRes;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SvgPackage.SVG_FILTER_ELEMENT__FILTER_RES, oldFilterRes, filterRes));
	}
	 ...
	 * @generated
	 */
	public FilterUnits getPrimitiveUnits() {
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SvgPackage.SVG_FILTER_ELEMENT__ID:
				return getId();
			case SvgPackage.SVG_FILTER_ELEMENT__XML_BASE:
				return getXml__base();
			case SvgPackage.SVG_FILTER_ELEMENT__XML_LANG:
				return getXml__lang();
			case SvgPackage.SVG_FILTER_ELEMENT__XML_SPACE:
				return getXml__space();
			case SvgPackage.SVG_FILTER_ELEMENT__ALIGNMENT_BASELINE:
				return getAlignment_baseline();
			case SvgPackage.SVG_FILTER_ELEMENT__BASELINE_SHIFT:
				return getBaseline_shift();
			case SvgPackage.SVG_FILTER_ELEMENT__CLIP:
				return getClip();
			case SvgPackage.SVG_FILTER_ELEMENT__CLIP_PATH:
				return getClip_path();
			case SvgPackage.SVG_FILTER_ELEMENT__CLIP_RULE:
				return getClip_rule();
			case SvgPackage.SVG_FILTER_ELEMENT__COLOR:
				return getColor();
			case SvgPackage.SVG_FILTER_ELEMENT__COLOR_INTERPOLATION:
				return getColor_interpolation();
			case SvgPackage.SVG_FILTER_ELEMENT__COLOR_INTERPOLATION_FILTERS:
				return getColor_interpolation_filters();
			case SvgPackage.SVG_FILTER_ELEMENT__COLOR_PROFILE:
				return getColor_profile();
			case SvgPackage.SVG_FILTER_ELEMENT__COLOR_RENDERING:
				return getColor_rendering();
			case SvgPackage.SVG_FILTER_ELEMENT__CURSOR:
				return getCursor();
			case SvgPackage.SVG_FILTER_ELEMENT__DIRECTION:
				return getDirection();
			case SvgPackage.SVG_FILTER_ELEMENT__DISPLAY:
				return getDisplay();
			case SvgPackage.SVG_FILTER_ELEMENT__DOMINANT_BASELINE:
				return getDominant_baseline();
			case SvgPackage.SVG_FILTER_ELEMENT__ENABLE_BACKGROUND:
				return getEnable_background();
			case SvgPackage.SVG_FILTER_ELEMENT__FILL:
				return getFill();
			case SvgPackage.SVG_FILTER_ELEMENT__FILL_OPACITY:
				return getFill_opacity();
			case SvgPackage.SVG_FILTER_ELEMENT__FILL_RULE:
				return getFill_rule();
			case SvgPackage.SVG_FILTER_ELEMENT__FILTER:
				return getFilter();
			case SvgPackage.SVG_FILTER_ELEMENT__FLOOD_COLOR:
				return getFlood_color();
			case SvgPackage.SVG_FILTER_ELEMENT__FLOOD_OPACITY:
				return getFlood_opacity();
			case SvgPackage.SVG_FILTER_ELEMENT__FONT_FAMILY:
				return getFont_family();
			case SvgPackage.SVG_FILTER_ELEMENT__FONT_SIZE:
				return getFont_size();
			case SvgPackage.SVG_FILTER_ELEMENT__FONT_SIZE_ADJUST:
				return getFont_size_adjust();
			case SvgPackage.SVG_FILTER_ELEMENT__FONT_STRETCH:
				return getFont_stretch();
			case SvgPackage.SVG_FILTER_ELEMENT__FONT_STYLE:
				return getFont_style();
			case SvgPackage.SVG_FILTER_ELEMENT__FONT_VARIANT:
				return getFont_variant();
			case SvgPackage.SVG_FILTER_ELEMENT__FONT_WEIGHT:
				return getFont_weight();
			case SvgPackage.SVG_FILTER_ELEMENT__GLYPH_ORIENTATION_HORIZONTAL:
				return getGlyph_orientation_horizontal();
			case SvgPackage.SVG_FILTER_ELEMENT__GLYPH_ORIENTATION_VERTICAL:
				return getGlyph_orientation_vertical();
			case SvgPackage.SVG_FILTER_ELEMENT__IMAGE_RENDERING:
				return getImage_rendering();
			case SvgPackage.SVG_FILTER_ELEMENT__KERNING:
				return getKerning();
			case SvgPackage.SVG_FILTER_ELEMENT__LETTER_SPACING:
				return getLetter_spacing();
			case SvgPackage.SVG_FILTER_ELEMENT__LIGHTING_COLOR:
				return getLighting_color();
			case SvgPackage.SVG_FILTER_ELEMENT__MARKER_END:
				return getMarker_end();
			case SvgPackage.SVG_FILTER_ELEMENT__MARKER_MID:
				return getMarker_mid();
			case SvgPackage.SVG_FILTER_ELEMENT__MARKER_START:
				return getMarker_start();
			case SvgPackage.SVG_FILTER_ELEMENT__MASKS:
				return getMasks();
			case SvgPackage.SVG_FILTER_ELEMENT__OPACITY:
				return getOpacity();
			case SvgPackage.SVG_FILTER_ELEMENT__OVERFLOW:
				return getOverflow();
			case SvgPackage.SVG_FILTER_ELEMENT__POINTER_EVENTS:
				return getPointer_events();
			case SvgPackage.SVG_FILTER_ELEMENT__SHAPE_RENDERING:
				return getShape_rendering();
			case SvgPackage.SVG_FILTER_ELEMENT__STOP_COLOR:
				return getStop_color();
			case SvgPackage.SVG_FILTER_ELEMENT__STOP_OPACITY:
				return getStop_opacity();
			case SvgPackage.SVG_FILTER_ELEMENT__STROKE:
				return getStroke();
			case SvgPackage.SVG_FILTER_ELEMENT__STROKE_DASHARRAY:
				return getStroke_dasharray();
			case SvgPackage.SVG_FILTER_ELEMENT__STROKE_DASHOFFSET:
				return getStroke_dashoffset();
			case SvgPackage.SVG_FILTER_ELEMENT__STROKE_LINECAP:
				return getStroke_linecap();
			case SvgPackage.SVG_FILTER_ELEMENT__STROKE_LINEJOIN:
				return getStroke_linejoin();
			case SvgPackage.SVG_FILTER_ELEMENT__STROKE_MITERLIMIT:
				return getStroke_miterlimit();
			case SvgPackage.SVG_FILTER_ELEMENT__STROKE_OPACITY:
				return getStroke_opacity();
			case SvgPackage.SVG_FILTER_ELEMENT__STROKE_WIDTH:
				return getStroke_width();
			case SvgPackage.SVG_FILTER_ELEMENT__TEXT_ANCHOR:
				return getText_anchor();
			case SvgPackage.SVG_FILTER_ELEMENT__TEXT_DECORATION:
				return getText_decoration();
			case SvgPackage.SVG_FILTER_ELEMENT__TEXT_RENDERING:
				return getText_rendering();
			case SvgPackage.SVG_FILTER_ELEMENT__UNICODE_BIDI:
				return getUnicode_bidi();
			case SvgPackage.SVG_FILTER_ELEMENT__VISIBILITY:
				return getVisibility();
			case SvgPackage.SVG_FILTER_ELEMENT__WORD_SPACING:
				return getWord_spacing();
			case SvgPackage.SVG_FILTER_ELEMENT__WRITING_MODE:
				return getWriting_mode();
			case SvgPackage.SVG_FILTER_ELEMENT__XLINK_HREF:
				return getXlink__href();
			case SvgPackage.SVG_FILTER_ELEMENT__XLINK_SHOW:
				return getXlink__show();
			case SvgPackage.SVG_FILTER_ELEMENT__XLINK_ACTUATE:
				return getXlink__actuate();
			case SvgPackage.SVG_FILTER_ELEMENT__XLINK_TYPE:
				return getXlink__type();
			case SvgPackage.SVG_FILTER_ELEMENT__XLINK_ROLE:
				return getXlink__role();
			case SvgPackage.SVG_FILTER_ELEMENT__XLINK_ARCROLE:
			...
			case SvgPackage.SVG_FILTER_ELEMENT__CLASS:
				return getClass_();
			case SvgPackage.SVG_FILTER_ELEMENT__STYLE:
				return getStyle();
			case SvgPackage.SVG_FILTER_ELEMENT__EXTERNAL_RESOURCES_REQUIRED:
				return getExternalResourcesRequired();
			case SvgPackage.SVG_FILTER_ELEMENT__X:
				return getX();
			case SvgPackage.SVG_FILTER_ELEMENT__Y:
				return getY();
			case SvgPackage.SVG_FILTER_ELEMENT__WIDTH:
				return getWidth();
			case SvgPackage.SVG_FILTER_ELEMENT__HEIGHT:
				return getHeight();
			case SvgPackage.SVG_FILTER_ELEMENT__FILTER_RES:
				return getFilterRes();
			case SvgPackage.SVG_FILTER_ELEMENT__FILTER_UNITS:
				return getFilterUnits();
			case SvgPackage.SVG_FILTER_ELEMENT__PRIMITIVE_UNITS:
				return getPrimitiveUnits();
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case SvgPackage.SVG_FILTER_ELEMENT__HEIGHT:
				...
				return;
			case SvgPackage.SVG_FILTER_ELEMENT__FILTER_RES:
				setFilterRes((String)newValue);
				return;
			case SvgPackage.SVG_FILTER_ELEMENT__FILTER_UNITS:
				setFilterUnits((FilterUnits)newValue);
				return;
			case SvgPackage.SVG_FILTER_ELEMENT__PRIMITIVE_UNITS:
				setPrimitiveUnits((FilterUnits)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case SvgPackage.SVG_FILTER_ELEMENT__HEIGHT:
				...
				return;
			case SvgPackage.SVG_FILTER_ELEMENT__FILTER_RES:
				setFilterRes(FILTER_RES_EDEFAULT);
				return;
			case SvgPackage.SVG_FILTER_ELEMENT__FILTER_UNITS:
				setFilterUnits(FILTER_UNITS_EDEFAULT);
				return;
			case SvgPackage.SVG_FILTER_ELEMENT__PRIMITIVE_UNITS:
				setPrimitiveUnits(PRIMITIVE_UNITS_EDEFAULT);
				return;
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case SvgPackage.SVG_FILTER_ELEMENT__FILTER_RES:
				return FILTER_RES_EDEFAULT == null ? filterRes != null : !FILTER_RES_EDEFAULT.equals(filterRes);
			case SvgPackage.SVG_FILTER_ELEMENT__FILTER_UNITS:
				return filterUnits != FILTER_UNITS_EDEFAULT;
			case SvgPackage.SVG_FILTER_ELEMENT__PRIMITIVE_UNITS:
				return primitiveUnits != PRIMITIVE_UNITS_EDEFAULT;
		}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == CoreAttributes.class) {
			switch (derivedFeatureID) {
				case SvgPackage.SVG_FILTER_ELEMENT__ID: return SvgPackage.CORE_ATTRIBUTES__ID;
				case SvgPackage.SVG_FILTER_ELEMENT__XML_BASE: return SvgPackage.CORE_ATTRIBUTES__XML_BASE;
				case SvgPackage.SVG_FILTER_ELEMENT__XML_LANG: return SvgPackage.CORE_ATTRIBUTES__XML_LANG;
				case SvgPackage.SVG_FILTER_ELEMENT__XML_SPACE: return SvgPackage.CORE_ATTRIBUTES__XML_SPACE;
				default: return -1;
			}
		}
		if (baseClass == PresentationAttributes.class) {
			switch (derivedFeatureID) {
				case SvgPackage.SVG_FILTER_ELEMENT__ALIGNMENT_BASELINE: return SvgPackage.PRESENTATION_ATTRIBUTES__ALIGNMENT_BASELINE;
				case SvgPackage.SVG_FILTER_ELEMENT__BASELINE_SHIFT: return SvgPackage.PRESENTATION_ATTRIBUTES__BASELINE_SHIFT;
				case SvgPackage.SVG_FILTER_ELEMENT__CLIP: return SvgPackage.PRESENTATION_ATTRIBUTES__CLIP;
				case SvgPackage.SVG_FILTER_ELEMENT__CLIP_PATH: return SvgPackage.PRESENTATION_ATTRIBUTES__CLIP_PATH;
				case SvgPackage.SVG_FILTER_ELEMENT__CLIP_RULE: return SvgPackage.PRESENTATION_ATTRIBUTES__CLIP_RULE;
				case SvgPackage.SVG_FILTER_ELEMENT__COLOR: return SvgPackage.PRESENTATION_ATTRIBUTES__COLOR;
				case SvgPackage.SVG_FILTER_ELEMENT__COLOR_INTERPOLATION: return SvgPackage.PRESENTATION_ATTRIBUTES__COLOR_INTERPOLATION;
				case SvgPackage.SVG_FILTER_ELEMENT__COLOR_INTERPOLATION_FILTERS: return SvgPackage.PRESENTATION_ATTRIBUTES__COLOR_INTERPOLATION_FILTERS;
				case SvgPackage.SVG_FILTER_ELEMENT__COLOR_PROFILE: return SvgPackage.PRESENTATION_ATTRIBUTES__COLOR_PROFILE;
				case SvgPackage.SVG_FILTER_ELEMENT__COLOR_RENDERING: return SvgPackage.PRESENTATION_ATTRIBUTES__COLOR_RENDERING;
				case SvgPackage.SVG_FILTER_ELEMENT__CURSOR: return SvgPackage.PRESENTATION_ATTRIBUTES__CURSOR;
				case SvgPackage.SVG_FILTER_ELEMENT__DIRECTION: return SvgPackage.PRESENTATION_ATTRIBUTES__DIRECTION;
				case SvgPackage.SVG_FILTER_ELEMENT__DISPLAY: return SvgPackage.PRESENTATION_ATTRIBUTES__DISPLAY;
				case SvgPackage.SVG_FILTER_ELEMENT__DOMINANT_BASELINE: return SvgPackage.PRESENTATION_ATTRIBUTES__DOMINANT_BASELINE;
				case SvgPackage.SVG_FILTER_ELEMENT__ENABLE_BACKGROUND: return SvgPackage.PRESENTATION_ATTRIBUTES__ENABLE_BACKGROUND;
				case SvgPackage.SVG_FILTER_ELEMENT__FILL: return SvgPackage.PRESENTATION_ATTRIBUTES__FILL;
				case SvgPackage.SVG_FILTER_ELEMENT__FILL_OPACITY: return SvgPackage.PRESENTATION_ATTRIBUTES__FILL_OPACITY;
				case SvgPackage.SVG_FILTER_ELEMENT__FILL_RULE: return SvgPackage.PRESENTATION_ATTRIBUTES__FILL_RULE;
				case SvgPackage.SVG_FILTER_ELEMENT__FILTER: return SvgPackage.PRESENTATION_ATTRIBUTES__FILTER;
				case SvgPackage.SVG_FILTER_ELEMENT__FLOOD_COLOR: return SvgPackage.PRESENTATION_ATTRIBUTES__FLOOD_COLOR;
				case SvgPackage.SVG_FILTER_ELEMENT__FLOOD_OPACITY: return SvgPackage.PRESENTATION_ATTRIBUTES__FLOOD_OPACITY;
				case SvgPackage.SVG_FILTER_ELEMENT__FONT_FAMILY: return SvgPackage.PRESENTATION_ATTRIBUTES__FONT_FAMILY;
				case SvgPackage.SVG_FILTER_ELEMENT__FONT_SIZE: return SvgPackage.PRESENTATION_ATTRIBUTES__FONT_SIZE;
				case SvgPackage.SVG_FILTER_ELEMENT__FONT_SIZE_ADJUST: return SvgPackage.PRESENTATION_ATTRIBUTES__FONT_SIZE_ADJUST;
				case SvgPackage.SVG_FILTER_ELEMENT__FONT_STRETCH: return SvgPackage.PRESENTATION_ATTRIBUTES__FONT_STRETCH;
				case SvgPackage.SVG_FILTER_ELEMENT__FONT_STYLE: return SvgPackage.PRESENTATION_ATTRIBUTES__FONT_STYLE;
				case SvgPackage.SVG_FILTER_ELEMENT__FONT_VARIANT: return SvgPackage.PRESENTATION_ATTRIBUTES__FONT_VARIANT;
				case SvgPackage.SVG_FILTER_ELEMENT__FONT_WEIGHT: return SvgPackage.PRESENTATION_ATTRIBUTES__FONT_WEIGHT;
				case SvgPackage.SVG_FILTER_ELEMENT__GLYPH_ORIENTATION_HORIZONTAL: return SvgPackage.PRESENTATION_ATTRIBUTES__GLYPH_ORIENTATION_HORIZONTAL;
				case SvgPackage.SVG_FILTER_ELEMENT__GLYPH_ORIENTATION_VERTICAL: return SvgPackage.PRESENTATION_ATTRIBUTES__GLYPH_ORIENTATION_VERTICAL;
				case SvgPackage.SVG_FILTER_ELEMENT__IMAGE_RENDERING: return SvgPackage.PRESENTATION_ATTRIBUTES__IMAGE_RENDERING;
				case SvgPackage.SVG_FILTER_ELEMENT__KERNING: return SvgPackage.PRESENTATION_ATTRIBUTES__KERNING;
				case SvgPackage.SVG_FILTER_ELEMENT__LETTER_SPACING: return SvgPackage.PRESENTATION_ATTRIBUTES__LETTER_SPACING;
				case SvgPackage.SVG_FILTER_ELEMENT__LIGHTING_COLOR: return SvgPackage.PRESENTATION_ATTRIBUTES__LIGHTING_COLOR;
				case SvgPackage.SVG_FILTER_ELEMENT__MARKER_END: return SvgPackage.PRESENTATION_ATTRIBUTES__MARKER_END;
				case SvgPackage.SVG_FILTER_ELEMENT__MARKER_MID: return SvgPackage.PRESENTATION_ATTRIBUTES__MARKER_MID;
				case SvgPackage.SVG_FILTER_ELEMENT__MARKER_START: return SvgPackage.PRESENTATION_ATTRIBUTES__MARKER_START;
				case SvgPackage.SVG_FILTER_ELEMENT__MASKS: return SvgPackage.PRESENTATION_ATTRIBUTES__MASKS;
				case SvgPackage.SVG_FILTER_ELEMENT__OPACITY: return SvgPackage.PRESENTATION_ATTRIBUTES__OPACITY;
				case SvgPackage.SVG_FILTER_ELEMENT__OVERFLOW: return SvgPackage.PRESENTATION_ATTRIBUTES__OVERFLOW;
				case SvgPackage.SVG_FILTER_ELEMENT__POINTER_EVENTS: return SvgPackage.PRESENTATION_ATTRIBUTES__POINTER_EVENTS;
				case SvgPackage.SVG_FILTER_ELEMENT__SHAPE_RENDERING: return SvgPackage.PRESENTATION_ATTRIBUTES__SHAPE_RENDERING;
				case SvgPackage.SVG_FILTER_ELEMENT__STOP_COLOR: return SvgPackage.PRESENTATION_ATTRIBUTES__STOP_COLOR;
				case SvgPackage.SVG_FILTER_ELEMENT__STOP_OPACITY: return SvgPackage.PRESENTATION_ATTRIBUTES__STOP_OPACITY;
				case SvgPackage.SVG_FILTER_ELEMENT__STROKE: return SvgPackage.PRESENTATION_ATTRIBUTES__STROKE;
				case SvgPackage.SVG_FILTER_ELEMENT__STROKE_DASHARRAY: return SvgPackage.PRESENTATION_ATTRIBUTES__STROKE_DASHARRAY;
				case SvgPackage.SVG_FILTER_ELEMENT__STROKE_DASHOFFSET: return SvgPackage.PRESENTATION_ATTRIBUTES__STROKE_DASHOFFSET;
				case SvgPackage.SVG_FILTER_ELEMENT__STROKE_LINECAP: return SvgPackage.PRESENTATION_ATTRIBUTES__STROKE_LINECAP;
				case SvgPackage.SVG_FILTER_ELEMENT__STROKE_LINEJOIN: return SvgPackage.PRESENTATION_ATTRIBUTES__STROKE_LINEJOIN;
				case SvgPackage.SVG_FILTER_ELEMENT__STROKE_MITERLIMIT: return SvgPackage.PRESENTATION_ATTRIBUTES__STROKE_MITERLIMIT;
				case SvgPackage.SVG_FILTER_ELEMENT__STROKE_OPACITY: return SvgPackage.PRESENTATION_ATTRIBUTES__STROKE_OPACITY;
				case SvgPackage.SVG_FILTER_ELEMENT__STROKE_WIDTH: return SvgPackage.PRESENTATION_ATTRIBUTES__STROKE_WIDTH;
				case SvgPackage.SVG_FILTER_ELEMENT__TEXT_ANCHOR: return SvgPackage.PRESENTATION_ATTRIBUTES__TEXT_ANCHOR;
				case SvgPackage.SVG_FILTER_ELEMENT__TEXT_DECORATION: return SvgPackage.PRESENTATION_ATTRIBUTES__TEXT_DECORATION;
				case SvgPackage.SVG_FILTER_ELEMENT__TEXT_RENDERING: return SvgPackage.PRESENTATION_ATTRIBUTES__TEXT_RENDERING;
				case SvgPackage.SVG_FILTER_ELEMENT__UNICODE_BIDI: return SvgPackage.PRESENTATION_ATTRIBUTES__UNICODE_BIDI;
				case SvgPackage.SVG_FILTER_ELEMENT__VISIBILITY: return SvgPackage.PRESENTATION_ATTRIBUTES__VISIBILITY;
				case SvgPackage.SVG_FILTER_ELEMENT__WORD_SPACING: return SvgPackage.PRESENTATION_ATTRIBUTES__WORD_SPACING;
				case SvgPackage.SVG_FILTER_ELEMENT__WRITING_MODE: return SvgPackage.PRESENTATION_ATTRIBUTES__WRITING_MODE;
				default: return -1;
			}
		}
		if (baseClass == XLinkAttributes.class) {
			switch (derivedFeatureID) {
				case SvgPackage.SVG_FILTER_ELEMENT__XLINK_HREF: return SvgPackage.XLINK_ATTRIBUTES__XLINK_HREF;
				case SvgPackage.SVG_FILTER_ELEMENT__XLINK_SHOW: return SvgPackage.XLINK_ATTRIBUTES__XLINK_SHOW;
				case SvgPackage.SVG_FILTER_ELEMENT__XLINK_ACTUATE: return SvgPackage.XLINK_ATTRIBUTES__XLINK_ACTUATE;
				case SvgPackage.SVG_FILTER_ELEMENT__XLINK_TYPE: return SvgPackage.XLINK_ATTRIBUTES__XLINK_TYPE;
		...
		if (baseClass == ContentElement.class) {
			switch (derivedFeatureID) {
				case SvgPackage.SVG_FILTER_ELEMENT__CHILDREN: return SvgPackage.CONTENT_ELEMENT__CHILDREN;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == CoreAttributes.class) {
			switch (baseFeatureID) {
				case SvgPackage.CORE_ATTRIBUTES__ID: return SvgPackage.SVG_FILTER_ELEMENT__ID;
				case SvgPackage.CORE_ATTRIBUTES__XML_BASE: return SvgPackage.SVG_FILTER_ELEMENT__XML_BASE;
				case SvgPackage.CORE_ATTRIBUTES__XML_LANG: return SvgPackage.SVG_FILTER_ELEMENT__XML_LANG;
				case SvgPackage.CORE_ATTRIBUTES__XML_SPACE: return SvgPackage.SVG_FILTER_ELEMENT__XML_SPACE;
				default: return -1;
			}
		}
		if (baseClass == PresentationAttributes.class) {
			switch (baseFeatureID) {
				case SvgPackage.PRESENTATION_ATTRIBUTES__ALIGNMENT_BASELINE: return SvgPackage.SVG_FILTER_ELEMENT__ALIGNMENT_BASELINE;
				case SvgPackage.PRESENTATION_ATTRIBUTES__BASELINE_SHIFT: return SvgPackage.SVG_FILTER_ELEMENT__BASELINE_SHIFT;
				case SvgPackage.PRESENTATION_ATTRIBUTES__CLIP: return SvgPackage.SVG_FILTER_ELEMENT__CLIP;
				case SvgPackage.PRESENTATION_ATTRIBUTES__CLIP_PATH: return SvgPackage.SVG_FILTER_ELEMENT__CLIP_PATH;
				case SvgPackage.PRESENTATION_ATTRIBUTES__CLIP_RULE: return SvgPackage.SVG_FILTER_ELEMENT__CLIP_RULE;
				case SvgPackage.PRESENTATION_ATTRIBUTES__COLOR: return SvgPackage.SVG_FILTER_ELEMENT__COLOR;
				case SvgPackage.PRESENTATION_ATTRIBUTES__COLOR_INTERPOLATION: return SvgPackage.SVG_FILTER_ELEMENT__COLOR_INTERPOLATION;
				case SvgPackage.PRESENTATION_ATTRIBUTES__COLOR_INTERPOLATION_FILTERS: return SvgPackage.SVG_FILTER_ELEMENT__COLOR_INTERPOLATION_FILTERS;
				case SvgPackage.PRESENTATION_ATTRIBUTES__COLOR_PROFILE: return SvgPackage.SVG_FILTER_ELEMENT__COLOR_PROFILE;
				case SvgPackage.PRESENTATION_ATTRIBUTES__COLOR_RENDERING: return SvgPackage.SVG_FILTER_ELEMENT__COLOR_RENDERING;
				case SvgPackage.PRESENTATION_ATTRIBUTES__CURSOR: return SvgPackage.SVG_FILTER_ELEMENT__CURSOR;
				case SvgPackage.PRESENTATION_ATTRIBUTES__DIRECTION: return SvgPackage.SVG_FILTER_ELEMENT__DIRECTION;
				case SvgPackage.PRESENTATION_ATTRIBUTES__DISPLAY: return SvgPackage.SVG_FILTER_ELEMENT__DISPLAY;
				case SvgPackage.PRESENTATION_ATTRIBUTES__DOMINANT_BASELINE: return SvgPackage.SVG_FILTER_ELEMENT__DOMINANT_BASELINE;
				case SvgPackage.PRESENTATION_ATTRIBUTES__ENABLE_BACKGROUND: return SvgPackage.SVG_FILTER_ELEMENT__ENABLE_BACKGROUND;
				case SvgPackage.PRESENTATION_ATTRIBUTES__FILL: return SvgPackage.SVG_FILTER_ELEMENT__FILL;
				case SvgPackage.PRESENTATION_ATTRIBUTES__FILL_OPACITY: return SvgPackage.SVG_FILTER_ELEMENT__FILL_OPACITY;
				case SvgPackage.PRESENTATION_ATTRIBUTES__FILL_RULE: return SvgPackage.SVG_FILTER_ELEMENT__FILL_RULE;
				case SvgPackage.PRESENTATION_ATTRIBUTES__FILTER: return SvgPackage.SVG_FILTER_ELEMENT__FILTER;
				case SvgPackage.PRESENTATION_ATTRIBUTES__FLOOD_COLOR: return SvgPackage.SVG_FILTER_ELEMENT__FLOOD_COLOR;
				case SvgPackage.PRESENTATION_ATTRIBUTES__FLOOD_OPACITY: return SvgPackage.SVG_FILTER_ELEMENT__FLOOD_OPACITY;
				case SvgPackage.PRESENTATION_ATTRIBUTES__FONT_FAMILY: return SvgPackage.SVG_FILTER_ELEMENT__FONT_FAMILY;
				case SvgPackage.PRESENTATION_ATTRIBUTES__FONT_SIZE: return SvgPackage.SVG_FILTER_ELEMENT__FONT_SIZE;
				case SvgPackage.PRESENTATION_ATTRIBUTES__FONT_SIZE_ADJUST: return SvgPackage.SVG_FILTER_ELEMENT__FONT_SIZE_ADJUST;
				case SvgPackage.PRESENTATION_ATTRIBUTES__FONT_STRETCH: return SvgPackage.SVG_FILTER_ELEMENT__FONT_STRETCH;
				case SvgPackage.PRESENTATION_ATTRIBUTES__FONT_STYLE: return SvgPackage.SVG_FILTER_ELEMENT__FONT_STYLE;
				case SvgPackage.PRESENTATION_ATTRIBUTES__FONT_VARIANT: return SvgPackage.SVG_FILTER_ELEMENT__FONT_VARIANT;
				case SvgPackage.PRESENTATION_ATTRIBUTES__FONT_WEIGHT: return SvgPackage.SVG_FILTER_ELEMENT__FONT_WEIGHT;
				case SvgPackage.PRESENTATION_ATTRIBUTES__GLYPH_ORIENTATION_HORIZONTAL: return SvgPackage.SVG_FILTER_ELEMENT__GLYPH_ORIENTATION_HORIZONTAL;
				case SvgPackage.PRESENTATION_ATTRIBUTES__GLYPH_ORIENTATION_VERTICAL: return SvgPackage.SVG_FILTER_ELEMENT__GLYPH_ORIENTATION_VERTICAL;
				case SvgPackage.PRESENTATION_ATTRIBUTES__IMAGE_RENDERING: return SvgPackage.SVG_FILTER_ELEMENT__IMAGE_RENDERING;
				case SvgPackage.PRESENTATION_ATTRIBUTES__KERNING: return SvgPackage.SVG_FILTER_ELEMENT__KERNING;
				case SvgPackage.PRESENTATION_ATTRIBUTES__LETTER_SPACING: return SvgPackage.SVG_FILTER_ELEMENT__LETTER_SPACING;
				case SvgPackage.PRESENTATION_ATTRIBUTES__LIGHTING_COLOR: return SvgPackage.SVG_FILTER_ELEMENT__LIGHTING_COLOR;
				case SvgPackage.PRESENTATION_ATTRIBUTES__MARKER_END: return SvgPackage.SVG_FILTER_ELEMENT__MARKER_END;
				case SvgPackage.PRESENTATION_ATTRIBUTES__MARKER_MID: return SvgPackage.SVG_FILTER_ELEMENT__MARKER_MID;
				case SvgPackage.PRESENTATION_ATTRIBUTES__MARKER_START: return SvgPackage.SVG_FILTER_ELEMENT__MARKER_START;
				case SvgPackage.PRESENTATION_ATTRIBUTES__MASKS: return SvgPackage.SVG_FILTER_ELEMENT__MASKS;
				case SvgPackage.PRESENTATION_ATTRIBUTES__OPACITY: return SvgPackage.SVG_FILTER_ELEMENT__OPACITY;
				case SvgPackage.PRESENTATION_ATTRIBUTES__OVERFLOW: return SvgPackage.SVG_FILTER_ELEMENT__OVERFLOW;
				case SvgPackage.PRESENTATION_ATTRIBUTES__POINTER_EVENTS: return SvgPackage.SVG_FILTER_ELEMENT__POINTER_EVENTS;
				case SvgPackage.PRESENTATION_ATTRIBUTES__SHAPE_RENDERING: return SvgPackage.SVG_FILTER_ELEMENT__SHAPE_RENDERING;
				case SvgPackage.PRESENTATION_ATTRIBUTES__STOP_COLOR: return SvgPackage.SVG_FILTER_ELEMENT__STOP_COLOR;
				case SvgPackage.PRESENTATION_ATTRIBUTES__STOP_OPACITY: return SvgPackage.SVG_FILTER_ELEMENT__STOP_OPACITY;
				case SvgPackage.PRESENTATION_ATTRIBUTES__STROKE: return SvgPackage.SVG_FILTER_ELEMENT__STROKE;
				case SvgPackage.PRESENTATION_ATTRIBUTES__STROKE_DASHARRAY: return SvgPackage.SVG_FILTER_ELEMENT__STROKE_DASHARRAY;
				case SvgPackage.PRESENTATION_ATTRIBUTES__STROKE_DASHOFFSET: return SvgPackage.SVG_FILTER_ELEMENT__STROKE_DASHOFFSET;
				case SvgPackage.PRESENTATION_ATTRIBUTES__STROKE_LINECAP: return SvgPackage.SVG_FILTER_ELEMENT__STROKE_LINECAP;
				case SvgPackage.PRESENTATION_ATTRIBUTES__STROKE_LINEJOIN: return SvgPackage.SVG_FILTER_ELEMENT__STROKE_LINEJOIN;
				case SvgPackage.PRESENTATION_ATTRIBUTES__STROKE_MITERLIMIT: return SvgPackage.SVG_FILTER_ELEMENT__STROKE_MITERLIMIT;
				case SvgPackage.PRESENTATION_ATTRIBUTES__STROKE_OPACITY: return SvgPackage.SVG_FILTER_ELEMENT__STROKE_OPACITY;
				case SvgPackage.PRESENTATION_ATTRIBUTES__STROKE_WIDTH: return SvgPackage.SVG_FILTER_ELEMENT__STROKE_WIDTH;
				case SvgPackage.PRESENTATION_ATTRIBUTES__TEXT_ANCHOR: return SvgPackage.SVG_FILTER_ELEMENT__TEXT_ANCHOR;
				case SvgPackage.PRESENTATION_ATTRIBUTES__TEXT_DECORATION: return SvgPackage.SVG_FILTER_ELEMENT__TEXT_DECORATION;
				case SvgPackage.PRESENTATION_ATTRIBUTES__TEXT_RENDERING: return SvgPackage.SVG_FILTER_ELEMENT__TEXT_RENDERING;
				case SvgPackage.PRESENTATION_ATTRIBUTES__UNICODE_BIDI: return SvgPackage.SVG_FILTER_ELEMENT__UNICODE_BIDI;
				case SvgPackage.PRESENTATION_ATTRIBUTES__VISIBILITY: return SvgPackage.SVG_FILTER_ELEMENT__VISIBILITY;
				case SvgPackage.PRESENTATION_ATTRIBUTES__WORD_SPACING: return SvgPackage.SVG_FILTER_ELEMENT__WORD_SPACING;
				case SvgPackage.PRESENTATION_ATTRIBUTES__WRITING_MODE: return SvgPackage.SVG_FILTER_ELEMENT__WRITING_MODE;
				default: return -1;
			}
		}
		if (baseClass == XLinkAttributes.class) {
			switch (baseFeatureID) {
				case SvgPackage.XLINK_ATTRIBUTES__XLINK_HREF: return SvgPackage.SVG_FILTER_ELEMENT__XLINK_HREF;
				case SvgPackage.XLINK_ATTRIBUTES__XLINK_SHOW: return SvgPackage.SVG_FILTER_ELEMENT__XLINK_SHOW;
				case SvgPackage.XLINK_ATTRIBUTES__XLINK_ACTUATE: return SvgPackage.SVG_FILTER_ELEMENT__XLINK_ACTUATE;
				case SvgPackage.XLINK_ATTRIBUTES__XLINK_TYPE: return SvgPackage.SVG_FILTER_ELEMENT__XLINK_TYPE;
		...
		if (baseClass == ContentElement.class) {
			switch (baseFeatureID) {
				case SvgPackage.CONTENT_ELEMENT__CHILDREN: return SvgPackage.SVG_FILTER_ELEMENT__CHILDREN;
				default: return -1;
			}
		}
	...
	public String toString() {
		...
		result.append(filterRes);
		result.append(", filterUnits: ");
		result.append(filterUnits);
		result.append(", primitiveUnits: ");
		result.append(primitiveUnits);
		result.append(')');
