 ...
 * <ul>
 *   <li>{@link at.bestsolution.efxclipse.tooling.efxbean.fXBean.impl.PackageDeclarationImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PackageDeclarationImpl extends MinimalEObjectImpl.Container implements PackageDeclaration
{
  ...
  {
    return FXBeanPackage.Literals.PACKAGE_DECLARATION;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FXBeanPackage.PACKAGE_DECLARATION__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case FXBeanPackage.PACKAGE_DECLARATION__NAME:
        return getName();
    }
