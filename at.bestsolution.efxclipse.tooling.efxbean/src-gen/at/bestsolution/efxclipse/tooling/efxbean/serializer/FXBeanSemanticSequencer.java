package at.bestsolution.efxclipse.tooling.efxbean.serializer;
...
public class FXBeanSemanticSequencer extends XbaseSemanticSequencer {

	@Inject
	private FXBeanGrammarAccess grammarAccess;
	
	public void createSequence(EObject context, EObject semanticObject) {
		if(semanticObject.eClass().getEPackage() == FXBeanPackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
			case FXBeanPackage.BEAN:
				if(context == grammarAccess.getBeanRule()) {
					sequence_Bean(context, (Bean) semanticObject); 
					return; 
				}
				else break;
			case FXBeanPackage.BEAN_ATTRIBUTE_DECL:
				if(context == grammarAccess.getBeanAttributeDeclRule()) {
					sequence_BeanAttributeDecl(context, (BeanAttributeDecl) semanticObject); 
					return; 
				}
				else break;
			case FXBeanPackage.BEAN_PROPERTY_DECL:
				if(context == grammarAccess.getBeanPropertyDeclRule()) {
					sequence_BeanPropertyDecl(context, (BeanPropertyDecl) semanticObject); 
					return; 
				}
				else break;
			case FXBeanPackage.FX_BEAN_UNIT:
				if(context == grammarAccess.getFXBeanUnitRule()) {
					sequence_FXBeanUnit(context, (FXBeanUnit) semanticObject); 
					return; 
				}
				else break;
			...
			case FXBeanPackage.MAP_TYPE_DEF:
				if(context == grammarAccess.getMapTypeDefRule() ||
				   context == grammarAccess.getTypeDefRule()) {
					sequence_MapTypeDef(context, (MapTypeDef) semanticObject); 
					return; 
				}
				else break;
			...
			case FXBeanPackage.VALUE_LIST_TYPE_DEF:
				if(context == grammarAccess.getTypeDefRule() ||
				   context == grammarAccess.getValueListTypeDefRule()) {
					sequence_ValueListTypeDef(context, (ValueListTypeDef) semanticObject); 
					return; 
				}
				else break;
			}
	...
	/**
	 * Constraint:
	 *     (readonly?='readonly'? lazy?='lazy'? reference?='reference'? type=TypeDef)
	 */
	protected void sequence_BeanAttributeDecl(EObject context, BeanAttributeDecl semanticObject) {
	...
	/**
	 * Constraint:
	 *     (readonly?='readonly'? lazy?='lazy'? reference?='reference'? type=TypeDef name=ID)
	 */
	protected void sequence_BeanPropertyDecl(EObject context, BeanPropertyDecl semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	/**
	 * Constraint:
	 *     (reflective?='reflective'? name=ValidID superType=JvmParameterizedTypeReference? (properties+=BeanPropertyDecl | attributes+=BeanAttributeDecl)*)
	 */
	protected void sequence_Bean(EObject context, Bean semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 */
	protected void sequence_FXBeanUnit(EObject context, FXBeanUnit semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 */
	protected void sequence_MapTypeDef(EObject context, MapTypeDef semanticObject) {
		if(errorAcceptor != null) {
	 ...
	 */
	protected void sequence_ValueListTypeDef(EObject context, ValueListTypeDef semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
}
