...
/**
 * Manual modifications go to {at.bestsolution.efxclipse.tooling.efxbean.FXBeanRuntimeModule}
 */
 @SuppressWarnings("all")
public abstract class AbstractFXBeanRuntimeModule extends DefaultRuntimeModule {

	protected Properties properties = null;

	@Override
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "at/bestsolution/efxclipse/tooling/efxbean/FXBean.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("at.bestsolution.efxclipse.tooling.efxbean.FXBean");
	}
	
	public void configureFileExtensions(Binder binder) {
		if (properties == null || properties.getProperty(Constants.FILE_EXTENSIONS) == null)
			binder.bind(String.class).annotatedWith(Names.named(Constants.FILE_EXTENSIONS)).toInstance("fxbean");
	}
	
	// contributed by org.eclipse.xtext.generator.grammarAccess.GrammarAccessFragment
	public Class<? extends org.eclipse.xtext.IGrammarAccess> bindIGrammarAccess() {
		return at.bestsolution.efxclipse.tooling.efxbean.services.FXBeanGrammarAccess.class;
	}

	// contributed by org.eclipse.xtext.generator.serializer.SerializerFragment
	public Class<? extends org.eclipse.xtext.serializer.sequencer.ISemanticSequencer> bindISemanticSequencer() {
		return at.bestsolution.efxclipse.tooling.efxbean.serializer.FXBeanSemanticSequencer.class;
	}

	// contributed by org.eclipse.xtext.generator.serializer.SerializerFragment
	public Class<? extends org.eclipse.xtext.serializer.sequencer.ISyntacticSequencer> bindISyntacticSequencer() {
		return at.bestsolution.efxclipse.tooling.efxbean.serializer.FXBeanSyntacticSequencer.class;
	}
	...
	public Class<? extends org.eclipse.xtext.parser.IParser> bindIParser() {
		return at.bestsolution.efxclipse.tooling.efxbean.parser.antlr.FXBeanParser.class;
	}
	...
	public Class<? extends org.eclipse.xtext.parser.antlr.IAntlrTokenFileProvider> bindIAntlrTokenFileProvider() {
		return at.bestsolution.efxclipse.tooling.efxbean.parser.antlr.FXBeanAntlrTokenFileProvider.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public Class<? extends org.eclipse.xtext.parser.antlr.Lexer> bindLexer() {
		return at.bestsolution.efxclipse.tooling.efxbean.parser.antlr.internal.InternalFXBeanLexer.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public com.google.inject.Provider<at.bestsolution.efxclipse.tooling.efxbean.parser.antlr.internal.InternalFXBeanLexer> provideInternalFXBeanLexer() {
		return org.eclipse.xtext.parser.antlr.LexerProvider.create(at.bestsolution.efxclipse.tooling.efxbean.parser.antlr.internal.InternalFXBeanLexer.class);
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public void configureRuntimeLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.parser.antlr.LexerBindings.RUNTIME)).to(at.bestsolution.efxclipse.tooling.efxbean.parser.antlr.internal.InternalFXBeanLexer.class);
	}
	...
	@org.eclipse.xtext.service.SingletonBinding(eager=true)	public Class<? extends at.bestsolution.efxclipse.tooling.efxbean.validation.FXBeanJavaValidator> bindFXBeanJavaValidator() {
		return at.bestsolution.efxclipse.tooling.efxbean.validation.FXBeanJavaValidator.class;
	}
	...
	public Class<? extends org.eclipse.xtext.formatting.IFormatter> bindIFormatter() {
		return at.bestsolution.efxclipse.tooling.efxbean.formatting.FXBeanFormatter.class;
	}
	...
	public Class<? extends org.eclipse.xtext.xbase.jvmmodel.IJvmModelInferrer> bindIJvmModelInferrer() {
		return at.bestsolution.efxclipse.tooling.efxbean.jvmmodel.FXBeanJvmModelInferrer.class;
	}
