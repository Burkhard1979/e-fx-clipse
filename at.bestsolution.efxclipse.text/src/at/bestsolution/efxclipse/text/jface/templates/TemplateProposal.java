...
import at.bestsolution.efxclipse.text.jface.contentassist.ICompletionProposalExtension;
import at.bestsolution.efxclipse.text.jface.contentassist.ICompletionProposalExtension2;
import at.bestsolution.efxclipse.text.jface.contentassist.ICompletionProposalExtension3;
import at.bestsolution.efxclipse.text.jface.contentassist.IContextInformation;
import at.bestsolution.efxclipse.text.jface.link.ProposalPosition;
import at.bestsolution.efxclipse.text.jface.templates.contentassist.PositionBasedCompletionProposal;
...
//			String[] arguments= new String[] { fTemplate.getName(), fTemplate.getDescription() };
			fDisplayString= fTemplate.getName() + " - " + fTemplate.getDescription();//JFaceTextTemplateMessages.getFormattedString("TemplateProposal.displayString", arguments); //$NON-NLS-1$
		}
