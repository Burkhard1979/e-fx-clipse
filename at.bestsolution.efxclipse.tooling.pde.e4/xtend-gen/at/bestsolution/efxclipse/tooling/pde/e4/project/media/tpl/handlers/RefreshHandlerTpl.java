...
public class RefreshHandlerTpl implements Generator<DynamicFile> {
  ...
  public CharSequence generate(final String packageName) {
    ...
    _builder.newLine();
    _builder.append("public class RefreshHandler {");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("public static final String REFRESH_EVENT = \"media/refresh\";");
    _builder.newLine();
    _builder.append("\t");
    _builder.newLine();
    _builder.append("\t");
    ...
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("broker.send(REFRESH_EVENT, UUID.randomUUID().toString());");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("}");
    _builder.newLine();
