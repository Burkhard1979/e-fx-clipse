...
public abstract class AdapterFactoryCellFactory {
	...
	/**
	 * A listener interface for callbacks that process {@link Cell}s being updated during {@link Cell#updateItem}.
	 */
	...
	final protected List<ICellCreationListener> cellCreationListeners = new ArrayList<>();
	final protected List<ICellUpdateListener> cellUpdateListeners = new ArrayList<>();
